    ...
    <div id="mobile-menu" class="md:hidden fixed inset-0 z-40 hidden">
        ...
        <div class="absolute top-0 left-0 bottom-0 w-72 bg-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                <a href="#hero" onclick="toggleMobileMenu()" class="flex items-center space-x-3 px-3 py-2.5 text-gray-700 rounded-xl hover:bg-blue-50 font-medium text-sm">Beranda</a>
                <a href="#tentang" onclick="toggleMobileMenu()" class="flex items-center space-x-3 px-3 py-2.5 text-gray-700 rounded-xl hover:bg-blue-50 font-medium text-sm">Tentang Kami</a>
                <a href="#layanan" onclick="toggleMobileMenu()" class="flex items-center space-x-3 px-3 py-2.5 text-gray-700 rounded-xl hover:bg-blue-50 font-medium text-sm">Layanan</a>
                <a href="#cara-kerja" onclick="toggleMobileMenu()" class="flex items-center space-x-3 px-3 py-2.5 text-gray-700 rounded-xl hover:bg-blue-50 font-medium text-sm">Cara Kerja</a>
                <a href="#statistik" onclick="toggleMobileMenu()" class="flex items-center space-x-3 px-3 py-2.5 text-gray-700 rounded-xl hover:bg-blue-50 font-medium text-sm">Statistik</a>
            </nav>
